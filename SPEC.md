...
| `midas new <name> --profile <p>` | Scaffold a conformant project: `midas.toml` (version-pinned), agent docs with the synced block, starter CI, dir shape. Runnable code `templates/` (rust-service/svelte-app) next. | **shipped** |
